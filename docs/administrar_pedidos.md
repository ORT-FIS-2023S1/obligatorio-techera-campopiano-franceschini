...
## Criterios de aceptación:
 ...
 - Puedo Registrar pedidos:
	 - Accedo a una pantalla donde puedo buscar al comensal por los
       ...
       identificador de alumno, Búsqueda por apellido y Búsqueda por grupo
...
- Puedo Ver Pedidos sin procesar: 
	...
	- Puedo filtrar y buscar los pedidos por diferentes criterios, como el estado del pedido, el nombre y apellido del alumno o la fecha de registro.
- Puedo Ver Pedidos Procesados:
	- Puedo acceder a una lista de todos los pedidos que han sido procesados y completados.
	- Puedo ver la información del alumno y los productos incluidos en cada pedido procesado.
	- Puedo filtrar y buscar los pedidos por diferentes criterios, como el estado del pedido, el nombre y apellido del alumno o la fecha de registro.
